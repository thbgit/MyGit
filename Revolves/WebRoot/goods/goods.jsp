	...
	<body>
		...
		<div class="container">
			...
			<div class="main">
				...
				<!--分类信息-->
				<div class="column">
					<span style="font-size: 18px; color: #333333;">女士香水</span>&nbsp;
				...
				<!--具体类别-->	
				<div class="kind">
					<a href="goods.jsp">女士香水</a><img src="${pageContext.request.contextPath }/img/goodsimages/arrows3.png" />
