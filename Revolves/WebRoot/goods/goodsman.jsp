		...
		<div class="container">
			...
			<div class="links">
				<ul class="links_list">
					...
					<li>
						<a href="selectGoods.do?classid=2" style="padding-bottom: 3px;border-bottom: 1px solid #F6F6F6;">男士香水</a>
					</li>
					<li>
			...
			<div class="main">
				...
				<!--分类信息-->
				<div class="column">
					<span style="font-size: 18px; color: #333333;">男士香水</span>&nbsp;
				...
				<!--具体类别-->	
				<div class="kind">
					<span style="font-size: 18px; color: #666666;margin-right: 10px;">男士香水</span><img src="${pageContext.request.contextPath }/img/goodsimages/arrows1.png" />
					<span style="font-size: 18px; color: #666666;margin-left: 10px;">柑橘香类</span>&nbsp;
					<span style="color:#C81D31; font-size: 14px;">101</span>&nbsp;
					<span style="font-size: 18px; color: #666666;">件</span>
				</div>
				...
				<div class="goods">
					...
					<c:forEach items="${GoodsList }" var="list">
						...
						<div class="out">
							<div class="con">
								<img src="${pageContext.request.contextPath }/img/goodsimages/${list.imgurl }">
								<div class="txt">
			...
			<!--分页信息-->
				...
				<a class="prePage" href="selectGoods.do?classid=${classid }&pageIndex=${pre }">
					<img src="${pageContext.request.contextPath }/img/goodsimages/arrows2.png" alt="上一页">
				</a>
				<c:forEach begin="1" end="${pageCount }" step="1" var="i">
					<a class="current" href="selectGoods.do?classid=${classid }&pageIndex=${i}">${i }</a>
				</c:forEach>
				<a class="nextPage" href="selectGoods.do?classid=${classid }&pageIndex=${next }">
					<img src="${pageContext.request.contextPath }/img/goodsimages/arrows1.png" alt="下一页">
						...
						<!--<div class="out">
							<div class="con">
								<img src="${pageContext.request.contextPath }/img/goodsimages/producter.png">
								<div class="txt">
									<img src="${pageContext.request.contextPath }/img/goodsimages/collect.png" />
									<p>查看详情</p>
								</div>
							...
							<div class="introduce">
								<p>OPIUM BLACK EDT</p>
								<p>圣罗兰黑鸦片淡香水</p>
								<span class="price">￥870-￥1250</span>
							</div>
						</div>
						<div class="out">
							<div class="con">
