...
-->
			...
			<div class="links">
				<ul class="links_list">
					...
					<li>
						<a href="${pageContext.request.contextPath }/goods/allgoods.jsp">会员尊享</a>
					</li>
				</ul>
			</div>
			...
			<div class="main">
				<div class="payleft">
					...
					<div class="payorder">
						<div class="payleftword">
							<span class="payword">账户余额</span>
							<span class="paymoney">￥${sessionScope.user.balance }</span>
						</div>
						<div class="payrightword">
							<span class="payword">实际支付</span>
							<span class="paymoney">￥${totalPrice-totalPrice*0.1 }</span>
						</div>
						<div>
						<form action="confirmpayment.do" method="post">
							<input class="orderbut" type="submit" value="确认付款"/>
						</form>
						</div>
						<div class="recharge">
							<a href="#">余额不足？去充值<img src="${pageContext.request.contextPath }/img/flow/confirmation2.png"/></a>
						</div>	
					</div>
				</div>
